...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/dacotta-banner2.png", // Path relative to the 'public' folder
  ...
  twitter: {
    ...
    images: ["/dacotta-banner2.png"], // Path relative to the 'public' folder
  },
  other: {
    ...
    "linkedin:image": "/dacotta-banner2.png",
  },
  icons: {
    icon: "/favicon.ico",
  },
